...
- Process Design kits (PDK) - is a library of basic photonic components generated by the foundary to give open access to their generic process for fabrication.
...
- LVS - Layout versus schematic (LVS) checking compares the extracted netlist from the layout to the 
